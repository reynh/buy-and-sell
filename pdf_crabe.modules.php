...
$pdf->SetFont('', '', $default_font_size - 1);
 ...
 $sql9=  "SELECT fax.authorizednet AS aut, fax.resolvelink AS res  FROM  ".MAIN_DB_PREFIX."facture AS f ";
...
//$pdf->write2DBarcode($fax, 'QRCODE,L', 112, 27, 26, 28, $style, 'N');
//$pdf->write2DBarcode($res, 'QRCODE,L', 112, 27, 26, 28, $style, 'N');
//$pdf->Text(20, 25, $fax. ' ' . $res);
