...
$pdf->MultiCell($widthrecbox, $hautcadre+5, "", 0,  'R', 1);
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey = "PdfOrderTitle")
	{
		...
		if ($object->ref_client)
		{
			...
			$pdf->SetTextColor(0, 0, 60);
			$pdf->MultiCell(120, 3, $outputlangs->transnoentities("RefCustomer")." : ".$outputlangs->convToOutputCharset($object->ref_client), '', 'R');
		}
      ...
      //  $pdf->MultiCell($largcol,5, "Editor"." : ".$userstatic->firstname.' '.$userstatic->lastname,0,'R',1);
		...
		if ($showaddress)
		{
			...
			$pdf->RoundedRect($posx, $posy, $widthrecbox+77, $hautcadre+3, 3, '1111', null, $styles);
			$pdf->SetLineStyle(array('dash'=>0));
			$pdf->SetTextColor(0, 0, 60);
		...
		//	$pdf->MultiCell(80, 4, $outputlangs->convToOutputCharset($this->emetteur->country), 0, 'L');
			...
			//$pdf->Rect($posx, $posy, $widthrecbox, $hautcadre);
						$styles = array('width' => 0.25, 'cap' => 'butt', 'join' => 'miter', 'dash' => '3,3');		
			$pdf->RoundedRect($posx, $posy, $widthrecbox+9, $hautcadre+3, 3, '1111', null, $styles);
			$pdf->SetLineStyle(array('dash'=>0));
			...
			$pdf->SetXY($posx + 2, $posy-1);
			$pdf->MultiCell($widthrecbox-50, 4, $carac_client, 0, 'L');
