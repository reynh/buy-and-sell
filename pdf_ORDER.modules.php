...
$sql20 ="SELECT p.jobaddress AS nu FROM "  . MAIN_DB_PREFIX . "commande_extrafields AS p  WHERE p.fk_object = " . &object->id;
            $resql4 = $db->query($sql20);
            $num5 = $db->num_rows($resql4);
            if($num5)
            {
			...
			$pdf->MultiCell(100, 3, $outputlangs->transnoentities("CustomerCode")." : ".$outputlangs->transnoentities($object->thirdparty->code_client), '', 'R');
		      $pdf->MultiCell(100, 3, " Jobaddress: ".$nu5, '', 'R');
}
